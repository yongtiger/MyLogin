...
public class FindPasswordRequestException extends RuntimeException {
    ...
    public FindPasswordRequestException(@ExceptionType int code) {
        this.code = code;
    }

    public FindPasswordRequestException(@ExceptionType int code, String message) {
        super(message);
        this.code = code;
    }

    public FindPasswordRequestException(@ExceptionType int code, String message, Throwable cause) {
        super(message, cause);
        this.code = code;
    }

    public FindPasswordRequestException(@ExceptionType int code, Throwable cause) {
        super(cause);
        this.code = code;
    }
