...
public class FindPasswordFindException extends RuntimeException {
    ...
    public FindPasswordFindException(@ExceptionType int code) {
        this.code = code;
    }

    public FindPasswordFindException(@ExceptionType int code, String message) {
        super(message);
        this.code = code;
    }

    public FindPasswordFindException(@ExceptionType int code, String message, Throwable cause) {
        super(message, cause);
        this.code = code;
    }

    public FindPasswordFindException(@ExceptionType int code, Throwable cause) {
        super(cause);
        this.code = code;
    }
