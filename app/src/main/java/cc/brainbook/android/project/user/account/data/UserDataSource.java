...
import static cc.brainbook.android.project.user.config.Config.LOGIN_URL;
import static cc.brainbook.android.project.user.config.Config.LOGOUT_URL;
import static cc.brainbook.android.project.user.config.Config.OAUTH_LOGIN_URL;
import static cc.brainbook.android.project.user.config.Config.OAUTH_UNBIND_URL;
import static cc.brainbook.android.project.user.config.Config.REGISTER_URL;
import static cc.brainbook.android.project.user.config.Config.USER_ACCOUNT_MODIFY_AVATAR_URL;
import static cc.brainbook.android.project.user.config.Config.USER_ACCOUNT_MODIFY_EMAIL_URL;
import static cc.brainbook.android.project.user.config.Config.USER_ACCOUNT_MODIFY_MOBILE_URL;
import static cc.brainbook.android.project.user.config.Config.USER_ACCOUNT_MODIFY_PASSWORD_URL;
import static cc.brainbook.android.project.user.config.Config.USER_ACCOUNT_MODIFY_USERNAME_URL;
