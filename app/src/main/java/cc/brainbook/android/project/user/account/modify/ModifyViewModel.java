...
import static cc.brainbook.android.project.user.account.modify.exception.ModifyException.EXCEPTION_FAILED_TO_MODIFY_EMAIL;
import static cc.brainbook.android.project.user.account.modify.exception.ModifyException.EXCEPTION_FAILED_TO_MODIFY_MOBILE;
import static cc.brainbook.android.project.user.account.modify.exception.ModifyException.EXCEPTION_FAILED_TO_MODIFY_PASSWORD;
import static cc.brainbook.android.project.user.account.modify.exception.ModifyException.EXCEPTION_FAILED_TO_MODIFY_USERNAME;
import static cc.brainbook.android.project.user.account.modify.exception.ModifyException.EXCEPTION_INVALID_PARAMETERS;
import static cc.brainbook.android.project.user.account.modify.exception.ModifyException.EXCEPTION_IO_EXCEPTION;
import static cc.brainbook.android.project.user.account.modify.exception.ModifyException.EXCEPTION_TOKEN_IS_INVALID_OR_EXPIRED;
import static cc.brainbook.android.project.user.account.modify.exception.ModifyException.EXCEPTION_UNKNOWN;
