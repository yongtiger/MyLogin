package cc.brainbook.android.project.login.resetpassword.util;
...
public class CountDownTimerUtil extends CountDownTimer {
    ...
    public void onTick(long millisUntilFinished) {
        ...
        mTextView.setBackgroundResource(R.drawable.reset_password_verification_code_press_bg); //设置按钮为灰色，这时是不能点击的
    ...
    public void onFinish() {
        ...
        mTextView.setBackgroundResource(R.drawable.reset_password_verification_code_normal_bg);  //还原背景色
    }
}