...
import static cc.brainbook.android.project.login.config.Config.RESET_PASSWORD_CHECK_SEND_MODE_URL;
import static cc.brainbook.android.project.login.config.Config.RESET_PASSWORD_FIND_USER_URL;
import static cc.brainbook.android.project.login.config.Config.RESET_PASSWORD_RESET_PASSWORD_URL;
import static cc.brainbook.android.project.login.config.Config.RESET_PASSWORD_SEND_VERIFICATION_CODE_URL;
import static cc.brainbook.android.project.login.config.Config.RESET_PASSWORD_VERIFY_CODE_URL;
