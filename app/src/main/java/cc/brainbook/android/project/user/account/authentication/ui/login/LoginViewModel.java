...
import static cc.brainbook.android.project.user.account.authentication.exception.LoginException.EXCEPTION_INVALID_OAUTH_NETWORK_AND_OPENID;
import static cc.brainbook.android.project.user.account.authentication.exception.LoginException.EXCEPTION_INVALID_PARAMETERS;
import static cc.brainbook.android.project.user.account.authentication.exception.LoginException.EXCEPTION_INVALID_PASSWORD;
import static cc.brainbook.android.project.user.account.authentication.exception.LoginException.EXCEPTION_INVALID_USERNAME;
import static cc.brainbook.android.project.user.account.authentication.exception.LoginException.EXCEPTION_IO_EXCEPTION;
import static cc.brainbook.android.project.user.account.authentication.exception.LoginException.EXCEPTION_UNKNOWN;
