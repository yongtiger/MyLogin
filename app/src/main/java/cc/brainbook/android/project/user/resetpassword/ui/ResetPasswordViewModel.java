...
import cc.brainbook.android.project.user.resetpassword.data.ResetPasswordRepository;
...
import static cc.brainbook.android.project.user.config.Config.REGEXP_VERIFICATION_CODE;
