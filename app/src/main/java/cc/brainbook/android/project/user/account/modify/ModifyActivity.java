...
import cc.brainbook.android.project.user.util.S3TransferUitl;

import static cc.brainbook.android.project.user.account.modify.exception.ModifyException.EXCEPTION_FAILED_TO_MODIFY_AVATAR;
